...
const styles = StyleSheet.create({
  ...
  avatarContainer: { position: 'relative', width: 60, height: 60, borderRadius: 30, overflow: 'hidden', marginRight: 12, borderWidth: 3, borderColor: '#11523d' },
  avatar: { width: '100%', height: '100%', backgroundColor: '#11523d', alignItems: 'center', justifyContent: 'center' },
  avatarImage: { width: '100%', height: '100%', borderRadius: 30 },
  avatarText: { color: '#FFFFFF', fontSize: 24, fontWeight: '700' },
  editImageButton: { position: 'absolute', bottom: 0, right: 0, backgroundColor: '#11523d', borderRadius: 12, width: 24, height: 24, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#FFFFFF', elevation: 5 },
  ...
  refreshButton: { backgroundColor: '#11523d', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, borderRadius: 8, marginBottom: 12 },
  ...
  saveButton: { flex: 1, backgroundColor: '#11523d', paddingVertical: 12, borderRadius: 8, alignItems: 'center', marginLeft: 8 },
